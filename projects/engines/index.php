...
<html lang="en-US">
    <head>
        <title>Engines | SEDS UC San Diego</title>
        ...
        <div class="page" id="top">
            ...
            <section class="page-section bg-dark bg-dark-alfa-70" data-background="https://sedsucsd.org/../../assets/images/sponsors/sponsor_header.jpg">
				...
				<div class="relative container align-left">                 
                    <div class="row">                        
                        <div class="col-md-6">
                            <h1 class="hs-line-11 font-alt mb-20 mb-xs-0">Engines</h1>
                            <div class="hs-line-4 font-alt">
								<br>
								The people who make our dreams possible
								<br>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mt-30">
                            <div class="mod-breadcrumbs font-alt align-right">
                                <a href="index.html">Home</a>&nbsp;/&nbsp; Sponsors</span>
                            </div>
                        </div>
                    </div>
                </div>
             ...
             <section class="small-section bg-dark pt-20 pb-40" style="background-color: #0E76BC;">
                <div class="container relative">                   
                    <div class="align-center">
                        ...
                        <div>
                            <a href="mailto:seds.ucsds@gmail.com" class="btn btn-mod btn-w btn-medium btn-round"><i class="fa fa-envelope"></i> &nbsp; Contact Us</a>
                        </div>
                    </div>
                </div>
            </section>
