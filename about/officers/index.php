...
<html lang="en-US">
<head>
	<title>Officers | SEDS UC San Diego</title>
	...
	<style type="text/css">
	.member-info	{ margin-top: -5px; }
	.officer_info	{ letter-spacing: 0.8px; font-family:'Roboto', Calibri, Helvetica, Serif; }
	.officer		{ display: block; }
	.officer_role	{ text-decoration: none; }
	</style>
...
<body class="appear-animate">
	...
	<div class="page" id="top">
		...
		<!-- Head Section -->
		<section class="page-section bg-dark bg-dark-alfa-70" data-background="../../assets/images/team/header.jpg">
