...
(function($) {
  ...
  Spin.defaults = {
    ...
    frameTime         : 120,           // Time in ms between updates. 40 is exactly 25 FPS
    ...
    scrollThreshold   : 70,           // Number of pixels the user must drag within a frame to enable page scroll (for touch devices)
