...
<html lang="en-US">
<head>
	<title>Sponsors | SEDS UCSD</title>
...
<body class="appear-animate">
	...
	<div class="page" id="top">
		...
		<!-- Head Section -->
		<section class="page-section bg-dark bg-dark-alfa-70" data-background="../assets/images/sponsors/header.jpg">
			<div class="divider"> &nbsp; </div>
			<div class="relative container align-left">
				<div class="row">
					<div class="col-md-6">
						<h1 class="hs-line-11 font-alt mb-20 mb-xs-0">Sponsors</h1>
						<div class="hs-line-4 font-alt">
							Making our dreams possible<br>
						</div>
					</div>
		...
		<section class="page-section">
			<div class="container relative">
				...
				<!-- Works Filter -->
				<div class="works-filter font-alt align-center bold">
					<a href="#" class="filter active" data-filter="*">All Sponsors</a>
					<a href="#branding" class="filter" data-filter=".platinum">Platinum</a>
					<a href="#design" class="filter" data-filter=".gold">Gold</a>
					<a href="#photography" class="filter" data-filter=".silver">Silver</a>
				</div>
				<!-- End Works Filter -->

				<!-- Works Grid -->
				<ul class="works-grid work-grid-6 clearfix font-alt hover-white hide-titles" id="work-grid">
					<li class="work-item mix platinum">
						<a href="https://www.thecollegeexpo.org/" target="blank" class="mfp-image">
							<div class="work-img">
								<img src="../assets/images/sponsors/ncrf.png" alt="ncrf" />
							</div>
							<div class="work-intro">
								<h3 class="work-title">National College Resources Foundation</h3>
							</div>
						</a>
					</li>

					<li class="work-item mix platinum">
						<a href="http://goscovalves.com/" target="blank" class="mfp-image">
							<div class="work-img">
								<img src="../assets/images/sponsors/gosco.png" alt="gosco" />
							</div>
							<div class="work-intro">
								<h3 class="work-title">Gosco Valves</h3>
							</div>
						</a>
					</li>

					<li class="work-item mix platinum">
						<a href="http://www.mtialbany.com/" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix platinum">
						<a href="http://gpiprototype.com/" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix platinum">
						<a href="http://www.jacobsschool.ucsd.edu/GordonCenter/" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix platinum">
						<a href="https://www.cadence.com/en/default.aspx" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix platinum">
						<a href="http://www.altium.com/" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix platinum">
						<a href="http://gantnerinstruments.com/" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix gold">
						<a href="https://www.cryoquip.com/" target="blank" class="mfp-image">
							<div class="work-img">
								<img src="../assets/images/sponsors/cryoquip.png" alt="cryoquip" />
							</div>
							<div class="work-intro">
								<h3 class="work-title">Cryoquip</h3>
							</div>
						</a>
					</li>

					<li class="work-item mix gold">
						<a href="http://parabilis-space.com/" target="blank" class="mfp-image">
							<div class="work-img">
								<img src="../assets/images/sponsors/parabilis.png" alt="parabilis" />
							</div>
							<div class="work-intro">
								<h3 class="work-title">Parabilis</h3>
							</div>
						</a>
					</li>

					<li class="work-item mix gold">
						<a href="http://www.solidworks.com/" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix gold">
						<a href="http://www.tecplot.com/" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix gold">
						<a href="https://www.qualcomm.com/" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix gold">
						<a href="http://www.opensourcemakerlabs.com/" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix gold">
						<a href="https://www.nimbix.net/" target="blank" class="mfp-image">
							<div class="work-img">
								<img src="../assets/images/sponsors/nimbix.png" alt="nimbix" />
							</div>
							<div class="work-intro">
								<h3 class="work-title">Nimbix</h3>
							</div>
						</a>
					</li>

					<li class="work-item mix silver">
						<a href="https://www.ansys.com/" target="blank" class="mfp-image">
							<div class="work-img">
								<img src="../assets/images/sponsors/ansys.png" alt="ansys" />
							</div>
							<div class="work-intro">
								<h3 class="work-title">Ansys</h3>
							</div>
						</a>
					</li>
					...
					<li class="work-item mix silver">
						<a href="https://virginorbit.com/" target="blank" class="mfp-image">
							<div class="work-img">
								<img src="../assets/images/sponsors/vorbit.png" alt="virgin orbit" />
							</div>
							<div class="work-intro">
								<h3 class="work-title">Virgin Orbit</h3>
							</div>
						</a>
					</li>

					<li class="work-item mix silver">
						<a href="hhttp://www.internationalsupersensors.com/" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix silver">
						<a href="http://www.spacemicro.com/" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix silver">
						<a href="http://mecam.me/" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix silver">
						<a href="http://www.astroaluminum.com/" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix silver">
						<a href="http://propulsion-analysis.com/" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix silver">
						<a href="http://blink.ucsd.edu/sponsor/CRMS/" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix silver">
						<a href="http://hofferflow.com/" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix silver">
						<a href="http://friendsofamateurrocketry.org/" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix silver">
						<a href="http://www.interfaceforce.com/index.php" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix silver">
						<a href="http://www.sentechmeas.com/" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix silver">
						<a href="https://www.8020.net/" target="blank" class="mfp-image">
							<div class="work-img">
					...
					<li class="work-item mix silver">
						<a href="https://www.digitalocean.com/" target="blank" class="mfp-image">
							<div class="work-img">
								<img src="../assets/images/sponsors/digitalocean.png" alt="digital ocean" />
							</div>
							<div class="work-intro">
								<h3 class="work-title">DigitalOcean</h3>
							</div>
						</a>
					</li>

					<li class="work-item mix silver">
						<a href="https://www.bilingualinteractive.com/" target="blank" class="mfp-image">
							<div class="work-img">
								<img src="../assets/images/sponsors/bilingual-interactive2.png" alt="bilingual" />
							</div>
							<div class="work-intro">
								<h3 class="work-title">Bilingual Interactive</h3>
							</div>
						</a>
					</li>
