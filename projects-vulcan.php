...
<html lang="en-US">
<head>
	<title>Page Moved | SEDS UCSD</title>
	...
	<meta http-equiv="refresh" content="8; url=https://www.sedsucsd.org/projects/vulcan/">
...
<body class="appear-animate">
	...
	<div class="page" id="top">
		...
		<!-- Home Section -->
		<section class="home-section bg-dark-alfa-50 parallax-5" data-background="assets/images/about/404.jpg" id="home">
					...
					<div class="home-text">
						<div class="row">
							<div class="col-md-10 col-md-offset-1 font-center">
								<p class="mb-30 font-condensed" style="font-size: 32px; font-weight: 500;">
									This page has been moved. Please update your links.
								</p>
								<h3 class="font-condensed mb-0"  style="font-weight: 500;">
									<a href="https://sedsucsd.org/projects/vulcan">https://www.sedsucsd.org/projects/vulcan</a>
								</h3>
		...
		<footer class="page-section bg-dark footer pb-60">
			<div class="container">
				...
				<div class="footer mb-40 mb-xs-30">
					...
					<p class="font-s-14">Photo: Erik Jepsen - UC San Diego Publications</p>
				</div>
				<!-- End Social Links -->
				<!-- Footer Text -->
