...
<html lang="en-US">
<head>
	<title>Colossus SFS Team | SEDS UCSD</title>
	...
	<div class="page" id="top">
		...
		<section class="page-section bg-dark bg-dark-alfa-70" data-background="../../assets/images/team/colossus_header.jpg">
			...
			<div class="relative container align-left">
				<div class="row">
					<div class="col-md-6">
						<h1 class="hs-line-11 font-alt mb-20 mb-xs-0">Colossus SFS Team</h1>
				...
				<div class="row multi-columns-row alt-features-grid mt-0 pt-0">
					...
					<div class="col-sm-4 col-md-3 col-lg-3">
						<div class="alt-features-item align-left mt-0 pt-0">
							...
							<div class="officer_role">Briana Puktianie</div>
							<div class="officer_role">Dennis Ren</div>
						</div>
					</div>
				</div>
			...
			<div class="container relative">
				<div class="row">
					<div class="col-md-12 col-sm-12">
						<img src="../../assets/images/team/colossus.jpg" alt="team">
					</div>
				</div>
			</div>
		</section>
