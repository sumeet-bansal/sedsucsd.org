...
<html lang="en-US">
<head>
	<title>Business Team | SEDS UCSD</title>
...
<body class="appear-animate">
	...
	<div class="page" id="top">
		...
		<!-- Head Section -->
		<section class="page-section bg-dark bg-dark-alfa-70" data-background="../../assets/images/team/business_header.jpg">
			<div class="divider"> &nbsp; </div>
			<div class="relative container align-left">
				<div class="row">
					<div class="col-md-8">
						<h1 class="hs-line-11 font-alt mb-20 mb-xs-0">Business Team</h1>
				...
				<div class="row multi-columns-row alt-features-grid">
					...
					<div class="col-sm-4 col-md-3 col-lg-3">
						<div class="alt-features-item align-left">
							...
							<div class="officer_name">Tzinti Aguirre-Medina</div>
							<div class="officer_role">Director of Media and Marketing</div>
						</div>
					</div>
					...
					<div class="col-sm-4 col-md-3 col-lg-3">
						<div class="alt-features-item align-left">
							...
							<div class="officer_name">Maxwell Kelly</div>
							<div class="officer_role">Lead Videographer</div>
						</div>
					</div>

					<a class="col-sm-4 col-md-3 col-lg-3 linkedinlink" href="https://www.linkedin.com/in/s-bansal" target="blank">
						<div class="alt-features-item align-left">
							<div class="alt-features-icon">
								<img src="../../assets/images/members/sumeet_bansal.jpg" alt="sumeet">
							</div>
							<div class="officer_name">Sumeet Bansal<img src="../../assets/images/misc/linkedin.png" alt="linkedin" class="linkedin"></div>
							<div class="officer_role">Webmaster</div>
						</div>
					</a>
					...
					<div class="col-sm-4 col-md-3 col-lg-3">
						<div class="alt-features-item align-left">
							...
							<div class="officer_role">Abby Patterson</div>
							<div class="officer_role">Daphne Kim</div>
							<div class="officer_role">Rebecca Donham</div>
							<div class="officer_role">Samantha Lee</div>
						</div>
					</div>
				...
				<div class="row multi-columns-row alt-features-grid mt-0 pt-0">
					...
					<div class="col-sm-4 col-md-3 col-lg-3">
						<div class="alt-features-item align-left mt-0 pt-0">
							<div class="officer_role">Albert Lin</div>
							<div class="officer_role">Eesha Tekriwal</div>
							<div class="officer_role">Ellis Lee</div>
							<div class="officer_role">Heather Dewis</div>
							<div class="officer_role">Winston Wong</div>
						</div>
					</div>
				</div>
				<!-- End Logo Grid -->
			...
			<div class="container relative">
				<div class="row">
					<div class="col-md-12 col-sm-12">
						<img src="../../assets/images/team/business.jpg" alt="team">
					</div>
				</div>
			</div>
		</section>
